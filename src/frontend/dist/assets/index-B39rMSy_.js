const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/StartPage-CaXsbDLW.js","assets/gameStore-DCN8N4SW.js","assets/MapPage-B7ZhEgd8.js","assets/LevelPage-2IrnIiw8.js","assets/MinigamePage-6qRq-fUI.js","assets/DialoguePage-HOgsEIu_.js","assets/EndingPage-C7NFdGAQ.js"])))=>i.map(i=>d[i]);
...
function Layout({ children, showScanlines = true }) {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "radial-gradient(ellipse 80% 50% at 50% 0%, oklch(0.56 0.26 330 / 0.12) 0%, transparent 60%), radial-gradient(ellipse 80% 50% at 50% 100%, oklch(0.91 0.26 200 / 0.10) 0%, transparent 60%)"
            }
          }
        ),
        showScanlines && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 pointer-events-none z-10 scanline opacity-40" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative z-20 flex flex-col items-center min-h-screen w-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full max-w-sm mx-auto min-h-screen flex flex-col", children }) })
      ]
    }
  );
}
function drawPixelSprite(ctx, sprite, x, y, scale = 4) {
...
const joshuaSprite = {
  pixels: [
    ...
    [null, "#d4956a", "#333333", "#d4956a", "#333333", null],
    // glasses
    ["#5c3317", "#d4956a", "#5c3317", "#5c3317", "#d4956a", "#5c3317"],
    // beard
    // Row 5: neck
...
function drawBackground(ctx, levelId, width, height) {
  const gradients = {
    0: ["#0a0e27", "#1a0a3a"],
    // Kolkata night
    1: ["#0a1a0a", "#1a2a0a"],
...
const StartPage = reactExports.lazy(() => __vitePreload(() => import("./StartPage-CaXsbDLW.js"), true ? __vite__mapDeps([0,1]) : void 0));
const MapPage = reactExports.lazy(() => __vitePreload(() => import("./MapPage-B7ZhEgd8.js"), true ? __vite__mapDeps([2,1]) : void 0));
const LevelPage = reactExports.lazy(() => __vitePreload(() => import("./LevelPage-2IrnIiw8.js"), true ? __vite__mapDeps([3,1,2]) : void 0));
const MinigamePage = reactExports.lazy(() => __vitePreload(() => import("./MinigamePage-6qRq-fUI.js"), true ? __vite__mapDeps([4,1,2]) : void 0));
const DialoguePage = reactExports.lazy(() => __vitePreload(() => import("./DialoguePage-HOgsEIu_.js"), true ? __vite__mapDeps([5,1]) : void 0));
const EndingPage = reactExports.lazy(() => __vitePreload(() => import("./EndingPage-C7NFdGAQ.js"), true ? __vite__mapDeps([6,1]) : void 0));
const queryClient$1 = new QueryClient();
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, { fallback: /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingScreen, {}), children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }) })
});
